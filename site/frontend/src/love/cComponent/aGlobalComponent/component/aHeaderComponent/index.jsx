...
import DefaultNavbarDropdown from "src/love/iTemplate/examples/Navbars/DefaultNavbar/DefaultNavbarDropdown";
    ...
    <Container sx={sticky ? { position: "sticky", top: 0, zIndex: 10 } : null}>
      ...
      >
        <MKBox display="flex" justifyContent="space-between" alignItems="center">
          ...
          >
            <MKBox component="img" src={brand.logo} alt="Brand" width="2.5rem" mr={1.5}/>
              ...
              Redux.state.ReceivedObject?.ProfileRetrieve ? (
                ...
                <React.Fragment>
                  <MKBox
                    ...
                    sx={{ cursor: "pointer", userSelect: "none" }}
                    component={Link}
                    to={FinalRouteName.AuthRoute.LoginRoute}
                  >
                    <MKTypography
                      variant="body2"
                      lineHeight={1}
                  ...
                  <MKBox
                    ...
                    sx={{ cursor: "pointer", userSelect: "none" }}
                    component={Link}
                    to={FinalRouteName.AuthRoute.RegisterRoute}
                  >
                    <MKTypography
                      variant="body2"
                      lineHeight={1}
        ...
        <MKBox
          ...
          px={transparent ? 2 : 0}
        >
          {mobileView && <DefaultNavbarMobile routes={routes} open={mobileNavbar} Redux={Redux} LogoutAPICall={LogoutAPICall} />}
        </MKBox>
      </MKBox>
      {dropdownMenu}
      {nestedDropdownMenu}
...
// Setting default values for the props of HeaderComponent
